...
class ReportController extends Controller
{
    ...
    /**
     * Show vendor payment report
     */
    public function payments()
    {
        $payments = VendorEventApplication::with(['event', 'vendor'])
            ->where('status', 'paid')
        ...
        $callback = function() use ($events) {
            ...
            foreach ($events as $event) {
                fputcsv($file, [
                    ...
                    $event->booth_price,
                    $event->booth_quantity,
                    $event->booth_sold,
                    $event->calculateBoothRevenue(),
                    $event->ticket_price,
                    $event->ticket_quantity,
                    $event->ticket_sold,
                    $event->calculateTicketRevenue(),
                    $event->total_revenue,
                    $event->venue_cost,
                    $event->staff_cost,
                    $event->equipment_cost,
                    $event->marketing_cost,
                    $event->other_costs,
                    $event->total_costs,
                    $event->net_profit,
                    $event->status
