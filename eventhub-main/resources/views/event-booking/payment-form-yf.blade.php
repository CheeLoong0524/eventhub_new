                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <strong>{{ $item->ticketType->event->name }}</strong><br>
                                                <small class="text-muted">{{ $item->ticketType->event->getFormattedDateTime() }}</small>
                                            </td>
                                            <td>{{ $item->ticketType->name }}</td>
                                            <td>{{ $item->quantity }}</td>
                                            <td>RM {{ number_format($item->ticketType->price, 2) }}</td>
                                            <td>RM {{ number_format($item->quantity * $item->ticketType->price, 2) }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
