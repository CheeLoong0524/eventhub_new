...
<div class="row g-4 mb-4">
    ...
    <div class="col-lg-3 col-md-6">
        <a href="{{ route('admin.vendor.applications') }}" class="text-decoration-none">
            <div class="card stats-card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="stats-number">{{ \App\Models\Vendor::where('status', 'pending')->count() }}</div>
        ...
        <div class="card quick-actions-card">
            <div class="card-header">
                <h5 class="mb-0 fw-bold">
                    <i class="fas fa-bolt me-2 text-warning"></i>Admin Quick Actions
                </h5>
                <p class="text-muted mb-0 small">Access frequently used administrative functions to manage the platform</p>
            </div>
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('admin.vendor.applications') }}" class="action-btn btn-warning">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('admin.vendor.vendors') }}" class="action-btn btn-success">
                            <i class="fas fa-users me-2"></i>Approved Vendors
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <a href="{{ route('admin.event-applications.index') }}" class="action-btn btn-info">
                            <i class="fas fa-file-alt me-2"></i>Booth Applications
                        </a>
                    </div>
                    <div class="col-lg-3 col-md-6">
