...
<style>
    ...
    .text-gradient {
        background: linear-gradient(45deg, #ffffff, #eef2ff);
    ...
    .feature-card { background: #fff; transition: all 0.3s ease; border: 1px solid #f1f3f5; }
    
    .feature-card:hover { transform: translateY(-4px); box-shadow: 0 12px 30px rgba(0,0,0,0.12); border-color: #667eea; }
    ...
    /* Improve CTA button contrast on gradient background */
        ...
        <div class="row justify-content-center" 
            <div class="col-lg-8" ">
                <div class="hero-content">
                    ...
                    <p class="lead mb-5 fs-5" style="color: rgba(255,255,255,0.92);">
...
<div class="container">
    <div class="row justify-content-center mb-5">
        <div class="col-lg-10">
            <div class="stats-section text-center p-4 bg-light rounded-3 shadow-sm">
                <div class="row">
                    <div class="col-md-4">
                        <div class="stat-item">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                <div class="cta-section bg-gradient text-white rounded-4 p-5 shadow-lg">
                    <h3 class="fw-bold mb-3 display-6">Ready to Get Started?</h3>
                    <p class="lead mb-4" style="color: rgba(255,255,255,0.95);">
